function League() {
	...
	*/
	...
	this.id = genUid(12);	// unique ID from functions.js
...
*/
	...
	//function to push vstext to array
	...
	this.build = function() {
		...
		*/
		...
		$('#c_teams li').each(function(i) {
			var tm = $(this).find('.team_name').text();		//in EDITING function in fixture.js
			ts.push(tm);
		})
		this.teams = ts;
		this.redraw(true);
